...
class Tripline:
    ...
    def add_collision(self, person):
        ...
        if key not in self._collisions:
            #print(str(person.meta[self._line_key]))
            #if(person.meta[self._line_key] == "Cikis"):
            #    self.count -=1
            # else:
            self.count += 1
            ...
            if buffer_key in person.meta:
                ...
                if(person.meta[self._line_key] == dir2):
                    self.count -= 2
                print("There are %d people inside." % self.count)
